...
return [
    ...
    'tr_melistoolcreator_database_desc' => 'L\'outil liste les entrées d\'une table afin de pouvoir les éditer. Merci de choisir une table. Si vous avez une table secondaire liée afin de gérer les traductions, cochez l\'option et choisissez la. Note : Les tables n\'ayant pas d\'auto increment sur leur clef primaire ne sont pas supportées par l\'outil',
