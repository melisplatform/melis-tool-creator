...
return [
    ...
    'tr_melistoolcreator_pk_fk_pri_tbl_lbl' => 'Foreign Key to the main table',
    'tr_melistoolcreator_pk_fk_lang_tbl_lbl' => 'Foreign key to the secondary table (contents by language)',
