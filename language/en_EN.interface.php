...
return [
    ...
    'tr_melistoolcreator_pri_tbl_cols_select' => 'Select the primary table',
    'tr_melistoolcreator_int_lang_tab' => 'Integrate the language tool tabulation',
    'tr_melistoolcreator_lang_tbl_lst' => 'Language table',
    'tr_melistoolcreator_select_lang_tbl_lst' => 'Select the language table',
    ...
    'tr_melistoolcreator_err_invalid_module' => 'Alphanumeric and underscore are the only valid characters allowed. The tool name cannot start by a number',
